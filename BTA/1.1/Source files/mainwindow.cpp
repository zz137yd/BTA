...
void MainWindow::copyFilePath()
{
    ...
    QString path;
    if (contextMenuIndex.isValid()) path = fileModel->filePath(contextMenuIndex);
    else if (contextMenuView == fileView) path = fPath;
    else if (contextMenuView == leftView) path = leftPath;
    else path = "";
